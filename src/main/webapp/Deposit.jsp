...
<section class="deposit-wrapper">
    <div class="container">
        <div class="deposit-card">
            <div class="mb-3">
                <div class="deposit-title">Deposit amount</div>
                <p class="deposit-sub">
                    Enter the account number, deposit amount, and your PIN to confirm the deposit.
                </p>
            </div>

            <!-- simplified form: accountNumber, amount, pin, remark -->
            <form action="Depositserv" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div class="mini-note mt-1">
                        Make sure the amount is correct before confirming the deposit.
                    </div>
                </div>
...
<footer>
    <div class="container d-flex flex-wrap justify-content-between">
        ...
        <span>Deposits are subject to bank verification and processing time.</span>
    </div>
</footer>
